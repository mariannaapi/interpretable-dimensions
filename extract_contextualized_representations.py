...
def careful_tokenization(sentence, tokenizer, model_name, maxlen):
    ...
    if not model_name in ["roberta-large", "roberta-base"]: 
        tok_sent.append('[SEP]')
...
if __name__ == '__main__':
    ...
    # Usage: python extract-contextualized-representations.py --sentences ukwac_sentences_complexity.pkl --modelname bert-large-uncased --output_dir bert_embeddings
    # Usage: python extract-contextualized-representations.py --sentences ukwac_sentences_complexity.pkl --modelname roberta-large --output_dir roberta_embeddings
...
if model_name in ["roberta-large", "roberta-base"]:  
    output = './roberta-embeddings'
    os.mkdir(output)

    pickle.dump(final_representations, open("roberta-large.formality.top4layers.pkl", "wb"))
